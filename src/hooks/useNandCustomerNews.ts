...
import { NAND_CUSTOMERS } from '@/lib/nand-constants';
...
export function useNandCustomerNews(customerId: NandCustomerId | null) {
  ...
  useEffect(() => {
    ...
    const customer = NAND_CUSTOMERS[customerId];
