...
import { useDramCustomerNews, NewsArticle } from '@/hooks/useDramCustomerNews';
...
export default function DramCustomerNews({
  customerId,
  companyName,
  companyColor,
  onClose,
}: DramCustomerNewsProps) {
          ...
          {articles.map((article, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <h4 className="mb-1.5 text-base font-semibold text-slate-900 group-hover:text-blue-600">
                  {article.title}
                </h4>
