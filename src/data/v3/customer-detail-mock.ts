import type { CustomerExecutive, CustomerDetailId, MonthlyMetricData, ConfigurableKpi, NewsCategory, AggregateCustomerId, WaferInOutQuarterlyEntry, BitGrowthQuarterlyEntry, EstimateTrendData } from '@/types/v3';
